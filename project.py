...
class main(tk.Frame):
    ...
    def zapisi(self, name, tel, email, salary):
        self.db.insert_data(name, tel, email, salary)
        self.view()

    def update_zapisi(self, name, tel, email, salary):
...
class Update(Child):
    ...
    def edited(self):
        ...
        btn_edit.bind('<Button-1>', lambda event: self.view.update_zapisi(self.entry_name.get(),
                                                                          self.entry_email.get(),
                                                                          self.entry_tel.get(),
                                                                          self.entry_wage.get()))
